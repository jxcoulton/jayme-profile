  ...
  return (
    <div id="about">
      ...
      <div className="about__content">
        <img className="about__pic" src="/AboutMePic.png" alt="jayme" />
        <h5 className="about__paragraph">
          My name is Jayme and I'm a Web Developer and Devmountain alumni
          seeking an exciting opportunity utilizing React
          or other modern Javascript frameworks and tools.  I aspire to work for an innovative company using modern languages and skills to create beautiful applications and state-of-the-art user experiences. I’m dedicated to expanding my knowledge and will prove how driven, resourceful, and passionate I am when it comes to creating and problem solving.
