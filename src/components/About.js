    ...
    <div id="about">
      ...
      <div className="about__content">
        ...
        <h5 className="about__paragraph">
          ...
          seeking an exciting opportunity utilizing React or other modern
          Javascript frameworks and tools. I aspire to work for an innovative
          company using modern languages and skills to create beautiful
          applications and state-of-the-art user experiences. I’m dedicated to
          expanding my knowledge and will prove how driven, resourceful, and
          passionate I am when it comes to creating and problem solving.
          <a
          ...
          <div className="about-contact-links contact__links">
            ...
            <a
              rel="noreferrer"
              href="https://github.com/jxcoulton"
              target="_blank"
            >
              <div
